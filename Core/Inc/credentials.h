...
#define BACKEND_CONFIG_URL "https://acdbentity-pension-symantec-pix.trycloudflare.com/config"
#define BACKEND_UPLOAD_URL "https://acdbentity-pension-symantec-pix.trycloudflare.com/upload"
